    ...
    private void initView(){
        ...
        btnGoFun.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                it.setClass(InitActivity.this, DecodeActivity.class);
                startActivity(it);
            }
        });
        ...
        btnJS.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent();
                it.setClass(InitActivity.this, JSUploadActivity.class);
                startActivity(it);
            }
        });
        ...
        btnAnyWifiPrint.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent();
                it.setClass(InitActivity.this, AnyPrinterActivity.class);
                startActivity(it);
            }
        });
...
//					break;
    ...
    private void initPrinter(){
        ...
        if (null == WorkService.workThread) {
            ...
            //ei always null
            Log.v(TAG, "--> InitActivity.onCreate"+((WorkService.workThread==null)?"workThread is null":"workThread not null"));
        }
            ...
            while (deviceIterator.hasNext()) {
                ...
                if(dev.getVendorId() == 0x067b || dev.getVendorId() == 0x0FE6){
                    ...
                    if (!usbManager.hasPermission(usbDev)) {
                        ...
                        USBPort port = new USBPort(usbManager, usbDev);
...
//							usbDev = (UsbDevice) intent.getParcelableExtra(UsbManager.EXTRA_DEVICE);
    ...
    //去demo界面
    private void goDemo(){
        Intent it = new Intent(InitActivity.this,DemoActivity.class);
        startActivity(it);
    }
    ...
    static class MHandler extends Handler {
        ...
        WeakReference<InitActivity> mActivity;

        MHandler(InitActivity activity) {
            mActivity = new WeakReference<InitActivity>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            InitActivity theActivity = mActivity.get();
            switch (msg.what) {
