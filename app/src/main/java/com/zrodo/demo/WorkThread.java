...
public class WorkThread extends Thread {
    ...
    private static final String TAG = "DrawerService";
...
//		btHeartBeat = BTHeartBeatThread.InitInstant(targetHandler);
        ...
        Log.d(TAG, (usbRW == null) ? "USBRWThread is null" : "USBRWThread not null" + " and " +
                ((usbHeartBeat == null) ? "USBHeartBeatThread is null" : "USBHeartBeatThread not null") + " and " +
                ((targetHandler == null) ? "targetHandler is null" : "targetHandler not null") + " and " +
                "threadInitOK=" + threadInitOK);
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Global.CMD_POS_WRITE: {
                    ...
                    if (result) {
                        //edit
                        int writeStatus = IO.Write(buffer, offset, count);
                        Log.d(TAG, "CMD_POS_WRITE ---> writeStatus=" + writeStatus);
                        smsg.arg1 = 1;
                    } else {
                        smsg.arg1 = 0;
                    }
                ...
                case Global.CMD_EPSON_SETQRCODEV2: {
                    ...
                    if (result) {
                        Pos.POS_EPSON_SetQRCodeV2(strQrcode, nWidthX, necl);
                        smsg.arg1 = 1;
                    } else {
                        smsg.arg1 = 0;
                    }
